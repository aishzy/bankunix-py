...
class DatabaseManager:
        ...
        if cls.instance is None:
            with cls._lock:
                if cls._instance is None:
                    cls._istance = super(DatabaseManager, cls).__new__(cls)
    ...
    def initialize_database(self) -> None:
        ...
        cursor.execute('CREATE INDEX IF NOT EXISTS idx_transfer_accounts ON transfers(from_account_id, to_account_id)')
