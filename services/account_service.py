...
class AccountService:
    ...
    def create_account(self, user_id: str, account_type: AccountType, currency: str = 'MYR') -> Tuple[bool, str, Optional[Account]]:
        """
        ...
        account = Account (
            ...
            interest_rate = interest_rate.get(account_type, 0.0)
        )
    ...
    def withdraw(self, account_id: str, amount: float, description: str  = "Withdraw") -> Tuple[bool, str]:
        """
    ...
    def apply_interest(self, account_id: str) -> Tuple[bool, str]:
        ...
        interest = CalculationUtils.calculate_simple_interest(account.balance, account.interest_rate, 1/12)
        interest = CalculationUtils.round_currency(interest)

        if interest <= 0:
            return True, "No interest found"
        ...
        transaction = Transaction (
            transaction_id = IDGenerator.generate_transction_id(),
            account_id = account_id, 
