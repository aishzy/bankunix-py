...
class TransferService:
    ...
    def tranfer_money(self, from_account_id: str, to_account_id: str, amount: float, description: str = 'Transfer') -> Tuple[bool, str]:
        """
        ...
        return True, f"Transfer of {amount} completed successfully. Reference: {transfer_id}"
    ...
    def get_transfer_history(self, account_id: str) -> List[Transfer]:
        ...
        return self.transfer_repo.get_tranfers_by_account(account_id)
